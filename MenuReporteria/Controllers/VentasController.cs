...
public class VentasController : Controller
{
    ...
    private byte[] GenerarReportePDF(ResultadoReporteVentas resultado)
    {
        using (MemoryStream ms = new MemoryStream())
        {
            ...
            foreach (string encabezado in encabezados)
            {
                ...
                celda.BorderWidth = 0;
                //celda.BorderBottomWidth = 2f;
                //celda.BorderBottomColor = new BaseColor(100, 150, 200);
    ...
    private byte[] GenerarReporteExcel(ResultadoReporteVentas resultado)
    {
        using (var package = new ExcelPackage())
        {
            ...
            // ESTILOS
            var styleEncabezado = worksheet.Cells.Style;
            var fontEncabezado = worksheet.Cells.Style.Font;
            fontEncabezado.Bold = true;
            fontEncabezado.Size = 12;
            // Cambiado a negro
            fontEncabezado.Color.SetColor(System.Drawing.Color.Black);
